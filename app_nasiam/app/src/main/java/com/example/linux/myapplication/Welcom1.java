...
public class Welcom1  extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_preload1);
        ...
        txtforword.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Welcom1.this, Welcom2.class);
                startActivity(i);
                finish();
        ...
        txtback.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Welcom1.this, SplashScreen.class);
                startActivity(i);
                finish();
            }
        });
